...
export const metadata: Metadata = {
  title: "Consultoría en Transformación Digital Empresarial | Radiast",
  description:
    "Estrategia tecnológica alineada al negocio para empresas medianas y grandes.",
  alternates: {
    canonical: "https://radiast.com/servicios/consultoria",
  },
};
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section className="bg-[#193864] text-white">
        <div className="mx-auto w-full max-w-440 px-6 py-2.5 md:px-10">
          <nav className="flex items-center gap-2 text-xs font-semibold md:text-sm">
            ...
            <span className="text-white/70">›</span>
            <span>Consultoría en Transformación Digital Empresarial</span>
          </nav>
        </div>
      </section>
      ...
      <section className="relative min-h-120 overflow-hidden md:min-h-130">
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/consultoria-hero.jpg'), url('https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=2200&q=80')",
          }}
        />
          ...
          <div className="cards-mobile-scroll flex gap-5 overflow-x-auto pb-3 snap-x snap-mandatory md:grid md:gap-6 md:overflow-visible md:pb-0 md:snap-none md:grid-cols-3">
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Identificamos cuellos de botella y rediseñamos flujos de trabajo para maximizar la eficiencia operativa y reducir tiempos de ciclo.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-4 h-1 w-12 bg-[#0ea5e9]" />
              <h3 className="mb-3 text-lg font-bold text-[#193356]">
                Estrategia digital alineada a resultados financieros
              </h3>
              <p className="text-sm leading-relaxed text-slate-600">
                Cada iniciativa tecnológica se diseña con foco en el impacto económico: reducción de costos, incremento de ingresos y mejora del margen operativo.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Eliminamos actividades sin valor agregado, duplicidades y procesos manuales que consumen recursos sin generar resultados tangibles.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Dotamos a la alta dirección de frameworks, datos y herramientas que fundamentan decisiones más rápidas, objetivas y con menor riesgo.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Preparamos la organización: datos, procesos y cultura, para adoptar con éxito tecnologías de RPA, IA y machine learning en sus operaciones.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Garantizamos que cada proyecto tecnológico responda directamente a prioridades estratégicas, evitando inversiones desconectadas del negocio.
              </p>
            </article>
          </div>
        </div>
