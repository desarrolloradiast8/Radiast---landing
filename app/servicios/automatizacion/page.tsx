...
export const metadata: Metadata = {
  title: "Automatización de Procesos Empresariales | Radiast",
  description:
    "Reducimos costos operativos y eliminamos tareas manuales mediante automatización inteligente.",
  alternates: {
    canonical: "https://radiast.com/servicios/automatizacion",
  },
};
          ...
          <div className="cards-mobile-scroll flex gap-5 overflow-x-auto pb-3 snap-x snap-mandatory md:grid md:gap-6 md:overflow-visible md:pb-0 md:snap-none md:grid-cols-3">
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Eliminamos actividades manuales de bajo valor que consumen tiempo y recursos, logrando reducciones de costos operativos significativas y sostenibles.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Los robots ejecutan procesos con precisión perfecta y consistente, eliminando errores de digitación, cálculo o transferencia de datos que generan retrabajo y pérdidas.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Conectamos tus plataformas ERP, CRM y sistemas administrativos para que la información fluya automáticamente sin intervención manual entre departamentos.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Automatizamos procesos de facturación, conciliaciones, reportes y gestión documental, liberando a tu equipo financiero y administrativo para tareas estratégicas.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Los procesos automatizados se ejecutan en segundos, reduciendo drásticamente los tiempos de ciclo y mejorando la capacidad de respuesta ante clientes y proveedores.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-4 h-1 w-12 bg-[#0ea5e9]" />
              <h3 className="mb-3 text-lg font-bold text-[#193356]">
                Aumento de productividad empresarial
              </h3>
              <p className="text-sm leading-relaxed text-slate-600">
                Al liberar a tu equipo de tareas repetitivas, se enfoca en actividades de mayor valor: análisis, innovación y atención al cliente, multiplicando el rendimiento organizacional.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-4 h-1 w-12 bg-[#0ea5e9]" />
              <h3 className="mb-3 text-lg font-bold text-[#193356]">
                Procesos escalables y controlados
              </h3>
              <p className="text-sm leading-relaxed text-slate-600">
                Los robots crecen con tu empresa: puedes escalar la automatización a nuevos procesos sin incrementar costos proporcionales, manteniendo control total y trazabilidad.
              </p>
            </article>
          </div>
        </div>
