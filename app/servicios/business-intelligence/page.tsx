...
export const metadata: Metadata = {
  title: "Business Intelligence y Analítica Empresarial | Radiast",
  description:
    "Decisiones estratégicas basadas en datos en tiempo real.",
  alternates: {
    canonical: "https://radiast.com/servicios/business-intelligence",
  },
};
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section className="bg-[#193864] text-white">
        <div className="mx-auto w-full max-w-440 px-6 py-2.5 md:px-10">
          <nav className="flex items-center gap-2 text-xs font-semibold md:text-sm">
            ...
            <span className="text-white/70">›</span>
            <span>Business Intelligence y Analítica Empresarial</span>
          </nav>
        </div>
      </section>
      ...
      <section className="relative min-h-120 overflow-hidden md:min-h-130">
        <Image
          src="/images/business-intelligent.png"
          alt="Business Intelligence y Analítica Empresarial"
          fill
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Implementamos dashboards interactivos con Power BI que consolidan indicadores críticos del negocio, accesibles desde cualquier dispositivo y actualizados automáticamente.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-4 h-1 w-12 bg-[#0ea5e9]" />
              <h3 className="mb-3 text-lg font-bold text-[#193356]">
                Control de indicadores estratégicos (KPIs)
              </h3>
              <p className="text-sm leading-relaxed text-slate-600">
                Definimos y monitoreamos los KPIs más relevantes para tu negocio: ventas, rentabilidad, eficiencia operativa y cumplimiento de objetivos estratégicos.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Creamos modelos analíticos que permiten controlar presupuestos, analizar desviaciones, proyectar flujos de caja y visualizar la salud financiera de la empresa en tiempo real.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-relaxed text-slate-600">
                Conectamos y centralizamos datos provenientes de ERP, CRM, hojas de cálculo, bases de datos y plataformas cloud en un único repositorio analítico coherente.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-4 h-1 w-12 bg-[#0ea5e9]" />
              <h3 className="mb-3 text-lg font-bold text-[#193356]">
                Mejora en planificación empresarial
              </h3>
              <p className="text-sm leading-relaxed text-slate-600">
                Con información centralizada y visibilidad completa, los equipos de dirección planifican con mayor precisión, anticipan escenarios y alinean recursos estratégicamente.
              </p>
            </article>
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-4 h-1 w-12 bg-[#0ea5e9]" />
              <h3 className="mb-3 text-lg font-bold text-[#193356]">
                Reducción de decisiones basadas en intuición
              </h3>
              <p className="text-sm leading-relaxed text-slate-600">
                Reemplazamos reportes manuales y juicios subjetivos por evidencia concreta: datos estructurados, tendencias visualizadas y análisis comparativos que guían cada decisión.
              </p>
            </article>
          </div>
        </div>
